...
<template><div ref="stage" class="video-stage"><div class="video-canvas-wrap" :style="{ width: `${previewSize.width}px`, height: `${previewSize.height}px` }"><canvas ref="canvas" aria-label="Video preview" /><div v-if="safeArea" class="video-safe-area" aria-hidden="true" /></div></div></template>
