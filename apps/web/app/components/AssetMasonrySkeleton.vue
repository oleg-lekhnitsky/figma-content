...
@media(max-width:2200px){.asset-skeleton-grid{grid-template-columns:repeat(6,minmax(0,1fr))}}
@media(max-width:1680px){.asset-skeleton-grid{grid-template-columns:repeat(5,minmax(0,1fr))}}
@media(max-width:1280px){.asset-skeleton-grid{grid-template-columns:repeat(4,minmax(0,1fr))}}
@media(max-width:900px){.asset-skeleton-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
