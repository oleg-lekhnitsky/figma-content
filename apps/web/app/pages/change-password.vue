...
<style scoped>.message-panel form{display:grid;gap:8px;margin-top:var(--space)}label{margin-top:8px;color:var(--color-muted);font-size:12px}input{box-sizing:border-box;width:100%;min-height:44px;padding:0 8px;border:0;border-bottom:1px solid var(--color-line);border-radius:0;color:inherit;background:transparent;font:inherit}small{color:var(--color-muted)}button{justify-self:start;margin-top:8px}.form-error{min-height:1.25rem;color:#a20f0f}:is(input,button):focus-visible{outline:2px solid #06f90e;outline-offset:2px}</style>
