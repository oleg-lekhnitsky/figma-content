...
.preview{background:transparent}.preview.is-loading{background:var(--color-surface)}.preview img{opacity:0;transition-property:opacity,transform;transition-duration:.22s,.35s;transition-timing-function:ease-out}.preview img.is-loaded{opacity:1}
